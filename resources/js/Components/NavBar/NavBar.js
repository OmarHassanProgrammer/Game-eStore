  ...
  return (
    <>
      <div className={styles.navbarCon}>
        <span className={styles.tog} onClick={toggle}>
          <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="M39 39v-7.85H9V39h30Zm0-10.85v-8.3H9v8.3h30Zm0-11.3V9H9v7.85h30ZM9 42q-1.2 0-2.1-.9Q6 40.2 6 39V9q0-1.2.9-2.1Q7.8 6 9 6h30q1.2 0 2.1.9.9.9.9 2.1v30q0 1.2-.9 2.1-.9.9-2.1.9Z"/></svg>
        </span>
        <motion.div 
          className={`${styles.navbar} ` + (toggleNavbar?styles.show:null)}
          animate="visible"
        ...
        >
          ...
          <div className={styles.navbar_right}>
              ...
              </div>
              {
                user?user.rank?<div 
                  className={styles.cartdiv} 
                  onClick={() => {location.href="/admin?page=orders"}}
                >
                  
                    <svg className={styles.svg2} xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="60px" height="60px" fill="#fff"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h240v-560H200v560Zm320 0h240v-280H520v280Zm0-360h240v-200H520v200Z"/></svg>
                    <h3 onClick={() => {location.href="/admin?page=orders"}}>Admin Dashboard</h3>
                </div>:null:null
              }
              {
                user?<div className={styles.dropboxContainer}>
                  ...
                  </div>
                  {
                    toggleUser?<div className={styles.userDropbox}>
                      ...
                      <div className={styles.item} onClick={() => {location.href = "/settings?page=balance"; setToggleUser(false);}}>Balance</div>
              ...
              }
              {
                user?<>
                  <div 
                      className={`${styles.cartdiv} ${styles.phone}`} 
                  ...
                  <div 
                      className={`${styles.cartdiv} ${styles.phone}`} 
                      onClick={() => {location.href = "/settings?page=balance";}}
                    >
                      <h3>Balance</h3>
                  </div>
                  <div 
